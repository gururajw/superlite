...
c-- physical constants
      ...
      real*8,parameter :: pc_pi16 = 16d0*pc_pi
...
c
c
c-- vectorized planck function
      pure function planckv(wl,temp) result(b)
c     ---------------------------------------
      implicit none
      real*8,intent(in) :: wl(:)
...
c-- optimized form
      ...
      end function planckv
c
c
c
      pure function planck(wl,temp) result(b)
c      -------------------------------------
      real*8,intent(in) :: wl,temp
      real*8 :: b
**************************************************
* Planck function at tempertaure, temp in K and
* wavelength, wl in cm
**************************************************
      real*8,parameter :: c1 = 2d0*pc_h*pc_c**2
      real*8,parameter :: c2 = pc_h*pc_c/pc_kb
