...
c     ---------------------------
      ...
      ct_npstepimc   => iregisters(:,5)
      ct_npstepddmc  => iregisters(:,6)
      ct_npstepmax   => iregisters(:,7)
      ct_npmethswap  => iregisters(:,8)
...
c
c
      subroutine counters_cycle(impi)
c     --------------------------------------------
      implicit none
...
c-- header
     ...
     &     'flux','stepimc','stepddmc','stepmax','methswap'
       endif
c-- body
